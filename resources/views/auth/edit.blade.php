                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('user.update',$user->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control" name="surname" value="{{ $user->profile->surname }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="code" type="text" class="form-control" name="code" value="{{ $user->profile->code }}" required>
                        ...
                        <div class="form-group{{ $errors->has('profile') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="profile" required autofocus>
                                    <option value="{{$user->profile->profile}}">{{$user->profile->profile}}</option>
