...
Route::group(['prefix'=>'author'], function()
	{
		Route::get('', ['uses'=>'AuthorController@index']);
...
Route::group(['prefix'=>'location'], function()
	{
		...
		Route::post('store', ['uses'=>'LocationController@store']);
...
Route::group(['prefix'=>'knowledge_area'], function()
	{
		Route::get('', ['uses'=>'Knowledge_areaController@index']);
		Route::get('create', ['uses'=>'Knowledge_areaController@create']);
		Route::post('store', ['uses'=>'Knowledge_areaController@store']);
...
Route::group(['prefix'=>'publisher'], function()
	{
		Route::get('', ['uses'=>'PublisherController@index']);
		Route::get('create', ['uses'=>'PublisherController@create']);
		Route::post('store', ['uses'=>'PublisherController@store']);
...
Route::group(['prefix'=>'subject'], function()
	{
		Route::get('', ['uses'=>'SubjectController@index']);
		Route::get('create', ['uses'=>'SubjectController@create']);
		Route::post('store', ['uses'=>'SubjectController@store']);
